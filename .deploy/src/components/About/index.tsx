          ...
          <Grid item md={3} sm={6} xs={12}>
            <div className="col">
              ...
              <div className="col-value">
                ...
                <a href="https://openreview.net/group?id=ICLR.cc/2025/Workshop/Bi-Alig#tab-recent-activity" target="_blank">Submission Portal</a>
              </div>
            </div>
          </Grid>
        </Grid>
        <div className="description" style={{ textAlign: "center" }}>All deadlines are 11:59 pm UTC-12h (“Anywhere on Earth”).</div>
        <Divider></Divider>
